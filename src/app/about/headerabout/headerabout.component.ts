...
export class HeaderaboutComponent {
  features = [
    { image: '/assets/Services elephant/1.webp', title: 'Mission', description: 'To craft beautiful and useful design solutions—across branding, events, packaging, CX centers, and video—that are intellectually stimulating, socially meaningful, and unforgettable.' },
    { image: '/assets/Services elephant/1.webp', title: 'Vision', description: 'To lead with creativity and cultural insight—collaborating with both multinationals and startups—to shape memorable experiences that defy the ordinary.' },
    { image: '/assets/Services elephant/1.webp', title: 'Values', description: 'At White Tusker, we lead with honesty, empathy, and courage—embracing change, listening deeply, and creating with purpose and heart.' }
  ];
